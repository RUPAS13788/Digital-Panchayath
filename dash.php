...
include 'databaseConnect.php';
 ...
 $c = $_GET["cid"];
  $sen = "SELECT * from classes where cid=$c";
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="dash.php?cid=<?php echo $_SESSION["qcid"] ?>&q=2">Ranking</a></li>
		
        <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active"'; ?>">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Quiz<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="dash.php?cid=<?php echo $_SESSION["qcid"] ?>&q=4">Add Quiz</a></li>
            <li><a href="dash.php?cid=<?php echo $_SESSION["qcid"] ?>q=5">Remove Quiz</a></li>
...
while($row = mysqli_fetch_array($result)) {
	...
	<td><b><a href="view.php?eid='.$eid.'" class="pull-right btn sub1" style="margin:0px;background:#99cc32"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1"><b>View</b></span></a></b></td></tr>';
...
include 'dbConnection.php';
$cid = $_SESSION["qcid"];
$q="SELECT * FROM rank where cid = ? ORDER BY score DESC";
$sp = mysqli_prepare($con,$q);
mysqli_stmt_bind_param($sp,'i',$cid);
mysqli_stmt_execute($sp);
$result = mysqli_stmt_get_result($sp);
...
$c++;
echo '<tr><td style="color:#99cc32"><b>'.$c.'</b></td><td>'.$e.'</td><td>'.$s.'</td><td>';
}
echo '</table></div></div>';}
