...
<body>
    ...
    <div>
        ...
        <h2><p>You have successfully created the classroom!!<br /><br /> <label>Your class code is : <?php echo $ccode ?> </label>  <br/><br />Please share this with students to join the class.
        	<br /> <br/>
        	<button class="button button1"><a href="facultyDashboard.php">OK!!</a></button> </p>
            <button class="button button1"><a href="autostudent.php">add students by year</a></button></p></h2>
    </div>
</div>
</body>
</html>