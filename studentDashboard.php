...
<div class="jumbotron">
<h2>Welcome to PANSOLVE all announcements will appear here <br>logged in as colony member</h2>
<br>              
</div>
    ...
    <div class="panel-group">
        ...
        $q = "SELECT * from announcements where cid in (select cid from studentclasses where sid = $uid) order by id desc";
