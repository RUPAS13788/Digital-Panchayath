...
.sidenav .closebtn {
  ...
  <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; </span> 
   ...
   <h3 align="center">Class Members</h3><br />
   <br />
...
<div id="group_chat_dialog" title="Group Chat Window" style="background-color: black;">
...
$(document).ready(function(){
 ...
 var modal_content = '<div id="user_dialog_'+to_user_id+'" class="user_dialog" title="You have chat with '+to_user_name+'">';
  modal_content += '<div style="height:400px; border:1px solid #ccc; overflow-y: scroll; margin-bottom:24px; padding:16px;background-color:black;" class="chat_history" data-touserid="'+to_user_id+'" id="chat_history_'+to_user_id+'">';
