...
<div class="jumbotron">
      ...
      <!-- <button class="btn btn-primary"  style="margin-bottom: 10px;" ><a href="exam/account.php?cid=<?php echo $id;?>&q=1">Exam Panel</a></button> -->
      <button class="btn btn-primary"  style="margin-bottom: 10px;" id = "view"><a href="index.php?clid=<?php echo $id;?>">View members</a></button>
       ...
       <!-- <button class="tablinks" onclick="openCity(event, 'stm')">StudyMaterials</button>-->
        ...
        <button class="tablinks" onclick="openCity(event, 'ass')">Problems Occured</button>
      </div>
