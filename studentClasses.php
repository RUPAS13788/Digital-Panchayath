...
<body>
  ...
  <a href="studentClasses.php">My Colonies</a>
...
<div class="jumbotron">
<h1>My Colonies <button class="btn" id = "myBtn" style="margin-left: 700px; margin-bottom: 10px;"><i class="fa fa-plus"></i></button></h1>              
</div>
</div>
        ...
        while($rows = $result->fetch_assoc()){
            ...
            while($rows1 = $result1->fetch_assoc()){
              ...
              echo '<img style="width:100%;height: 200px;" src="'.$l.'" class="card-img-top" alt="EyeGlasses">
                <div class="card-body ">
                <h5 class="card-title">Colony : '.$rows1['cname'].'</h5>
                ...
                <div class="card-body" style="background-color: black">
                    ...
                    <form method="POST" action="joinClass.php">
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Enter Colony Code" name="code" required="required">
                        </div>
