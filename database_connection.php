...
$result = mysqli_stmt_get_result($sp);
 ...
 foreach($result as $row)
 {
  ...
  <li style="border-bottom:1px dotted #ccc">
   <p style="color:white;">'.$user_name.' - '.$row["chat_message"].'
    <div align="right">
     - <small><em style="color:white;">'.$row['timestamp'].'</em></small>
    </div>
   </p>
  </li>
  ';
...
$result = mysqli_stmt_get_result($sp);
 ...
 foreach($result as $row)
 {
  if($row["is_type"] == 'yes')
  {
   $output = ' - <small><em><span class="text-muted" style="color:red;">Typing...</span></em></small>';
  }
 }
 return $output;
}
