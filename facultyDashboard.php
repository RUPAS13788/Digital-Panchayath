...
<div class="jumbotron">
<h1>Welcome To PANSOLVE <button class="btn" id = "myBtn" style="margin-left: 350px; margin-bottom: 10px;"><i class="fa fa-plus"></i></button><br>logged in as Panchayat head
</h1>              
</div>
</div>
...
<div class="card-group">
  	...
  	<?php
        $q = "SELECT * from classes where fid = $fid ";
        ...
        while($rows = $result->fetch_assoc()){
            ...
            echo '<a href="viewClass.php?id='.$id.'">';
            ...
            <div class="card-body ">
            <h5 class="card-title">Colony : '.$rows['cname'].'</h5>
            <p class="card-text"><h5>Code is : '.$rows['ccode'].'</h5></p>
            <p class="card-text text1"><h5><label class="pc">Panchayithi head :'.$rows['fid'].'</label></h5></p> 
            </div>';
            echo '</div>';
            echo '</a>';
            echo '</div>';
        ...
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                ...
                <div class="card-body" style="background-color: black">
                    ...
                    <form method="POST" action="addClassToDatabase.php">
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Subject Name" name="name" required="required">
                        </div>
                        <div class="input-group">
